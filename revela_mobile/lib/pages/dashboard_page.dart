  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        padding: const EdgeInsets.only(bottom: 90.0), // Push above the MainLayout custom navbar
        child: FloatingActionButton.extended(
          ...
          icon: const Icon(Icons.support_agent_rounded, color: Color(0xFF0F3E22)),
          label: const Text(
            'Admin',
            style: TextStyle(color: Color(0xFF0F3E22), fontWeight: FontWeight.bold),
          ),
        ),
      ),
      body: SafeArea(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.refresh_rounded, color: context.adaptiveTextMid, size: 22),
                    ...
                    Positioned(
                      ...
                      child: ClipRect(
                        child: Align(
                          ...
                          heightFactor: 0.5, // 120 * 0.5 = 60px (perfectly meets the 60px top margin)
                          child: Image.asset(
                            ...
                            children: [
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    if (verifiedCount > 0)
                                      Expanded(flex: verifiedCount, child: Container(color: AppColors.darkGreen)),
                                    if (submittedCount > 0)
                                      Expanded(flex: submittedCount, child: Container(color: AppColors.gold)),
                                    if (assignedCount > 0)
                                      Expanded(flex: assignedCount, child: Container(color: Colors.grey[400])),
                                  ],
                                ),
                              ),
                              const SizedBox(height: 12),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  _buildProgressLegend('Verified', verifiedCount, AppColors.darkGreen),
                                  _buildProgressLegend('Submitted', submittedCount, AppColors.gold),
                                  _buildProgressLegend('Assigned', assignedCount, Colors.grey[400]!),
                                ],
                              ),
                            ],
                          );
